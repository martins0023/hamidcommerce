...
import { Ellipse, EllipseSelected, illustration1 } from "../assets";
      ...
      <div className="w-full h-full flex justify-center items-center justify-items-center">
        ...
        >
          <div className="flex flex-col items-center justify-items-center">
            ...
            <p className="text-original w-[216px] mt-20 h-[54px] text-center text-[18px] font-semibold">
              The greatest journey of online shop
            </p>
          </div>

          <div className="flex flex-col mt-20 mb-0 gap-0">
