...
const Details = () => {
  ...
  if (!product) {
    return (
      <div className="text-black text-center items-center">Loading...</div>
    );
  }
    ...
    switch (activeTab) {
      case "description":
        return (
          <div className="pb-10">
            ...
            <h4 className="font-semibold mt-4 text-black text-[14px]">
              Size & Fit
            </h4>
            <p className="text-black text-[14px]">
              Lorem ipsum velit esse cillum dolore eu fugiat nulla pariatur.
            </p>
            <h4 className="font-semibold mt-4 text-black text-[14px]">
              Material & Care
            </h4>
            <p className="text-black text-[14px]">
              Lorem ipsum velit esse cillum la pariatur.
            </p>
          </div>
        );
      case "specification":
      ...
      case "details":
        return (
          <div>
            <p className="text-black text-[14px]">
              Additional product details go here. You can add more content or
  ...
  return (
    <div className="pb-20">
      ...
      <div className="m-4 flex justify-between">
        ...
        <button onClick={handleBuyNow} className="flex-1 bg-[#FE8946] text-white font-semibold py-2 px-4 rounded-md ml-2">
          BUY NOW
        </button>
      </div>
    </div>
